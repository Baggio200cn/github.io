...
function getWeChatInlineStyles() {
  return {
    ...
    p: 'margin:16px 0;line-height:1.8;letter-spacing:.02em;color:#222;font-size:16px;',
    strong: 'font-weight:700;color:#0F4C81;',
    em: 'font-style:italic;',
    ul: 'padding-left:24px;margin:14px 0;',
    ol: 'padding-left:24px;margin:14px 0;',
    li: 'margin:6px 0;line-height:1.8;color:#222;font-size:16px;',
    blockquote: 'margin:16px 0;padding:12px 14px;border-left:4px solid #0F4C81;background:#f4f8fb;color:#555;',
    code: 'padding:2px 6px;background:#f1f3f5;border-radius:3px;font-family:Consolas,Monaco,"Courier New",monospace;font-size:.9em;color:#c7254e;',
    pre: 'margin:16px 0;padding:12px;background:#f8f8f8;border:1px solid #e0e0e0;border-radius:4px;overflow-x:auto;',
...
/** Markdown -> 公众号可粘贴 HTML（带内联样式，且无外层容器） */
